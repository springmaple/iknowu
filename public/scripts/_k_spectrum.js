...
(function (window, $, undefined) {
    ...
    function paletteTemplate (p, color, className) {
        ...
        for (var i = 0; i < p.length; i++) {
            ...
            html.push('<span title="' + tiny.toName() + '" data-color="' + tiny.toRgbString() + '" class="' + c + '"><span class="sp-thumb-inner" style="' + swatchStyle + ';" /></span>');
        }
    ...
    function spectrum(element, o) {
        ...
        function updateOriginalInput(fireCallback) {
            ...
            var hasChanged = true; // !tinycolor.equals(color, colorOnShow);
            colorOnShow = color;
